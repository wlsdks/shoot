...
import com.stark.shoot.application.service.chat.SendChatService
...
class SendChatServiceTest {
    ...
    // 일단 위에서 생성한 mock 객체를 사용하여 SendChatService 객체를 생성한다.
    private val sendChatService = SendChatService(saveChatMessagePort, loadChatRoomPort, eventPublisher)
    ...
    fun sendMessageSuccessTest() {
        ...
        // 메서드 호출
        val result = sendChatService.sendMessage(roomId, senderId, message)
